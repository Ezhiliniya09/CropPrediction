...
def analyse():
	if(request.method == "POST"):
		...
		optimum['HUMIDITY'] = optimum.HUMIDITY.astype(float)
		optimum['PH'] = optimum.PH.astype(float)
		optimum['RAINFALL'] = optimum.RAINFALL.astype(float)
		...
		if(request.form.get('Potassium') == None):
			...
			print(price["Price/hr"].iloc[[0]])
			print("111111111111111111111")
			print(price["Price/hr"].iloc[p1])
			print("cccccccccccccccccccccccc")
			print(price["Price/hr"].iloc[p2])
			# print()
